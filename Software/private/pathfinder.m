%% Path Finder Funcion for Visibility Graph 
...
% % 
% % h=0;tic
% % for ID = 1:size(ii,1)%1:size(initial_combined_nodes,1)
% %     
...
% %     
% % %     for target_ID = ii(:,2)%1:size(initial_combined_nodes,1)
% %         
% %         %Assign observer and target nodes
% %         observer_state = initial_combined_nodes(ii(ID,1),:);
% %         current_target_node = initial_combined_nodes(ii(ID,2),:);
% %         
